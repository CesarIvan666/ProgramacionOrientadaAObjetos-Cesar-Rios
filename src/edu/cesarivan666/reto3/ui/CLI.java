        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    number = sc.next();
                    System.out.println("El resultado en binario es: " +  ConversorNumerico.decimalToBinary(Integer.parseInt(number)));
                    break;
                case 2:
                    System.out.print("Ingrese el numero decimal: ");
                    number = sc.next();
                    System.out.println("El resultado en octal es: " + ConversorNumerico.decimalToOctal(Integer.parseInt(number)));
                    break;
                case 3:
                    System.out.print("Ingrese el numero decimal: ");
                    number = sc.next();
                    System.out.println("El resultado en hexadecimal es: " + ConversorNumerico.decimalToHexadecimal(Integer.parseInt(number)));
                    break;
                case 4:
